  ...
  '/recipes/': [
    {
      ...
      items: [
        ...
        { text: 'Infinite query (live demo)', link: '/recipes/infinite-query' },
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'OpenAPI codegen (hey-api)', link: '/recipes/openapi' },
        { text: 'TanStack & Apollo interop', link: '/recipes/interop' },
        { text: 'Vite (SPA)', link: '/recipes/vite' },
        { text: 'Next.js (App Router)', link: '/recipes/nextjs' },
        { text: 'TanStack Start', link: '/recipes/tanstack-start' },
        { text: 'Vike', link: '/recipes/vike' },
  ...
  '/ru/recipes/': [
    {
      ...
      items: [
        ...
        { text: 'Infinite query (живое демо)', link: '/ru/recipes/infinite-query' },
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Кодогенерация из OpenAPI (hey-api)', link: '/ru/recipes/openapi' },
        { text: 'Интеграция с TanStack и Apollo', link: '/ru/recipes/interop' },
        { text: 'Vite (SPA)', link: '/ru/recipes/vite' },
        { text: 'Next.js (App Router)', link: '/ru/recipes/nextjs' },
        { text: 'TanStack Start', link: '/ru/recipes/tanstack-start' },
        { text: 'Vike', link: '/ru/recipes/vike' },
